...
namespace Utilities.Models
{
    public partial class InMemoryEventBusSubscriptionsManager : IEventBusSubscriptionsManager
    {
        ...
        public void AddDynamicSubscription<TH>(string eventName) where TH : IDynamicIntegrationEventHandler =>
            Subscribe(typeof(TH), eventName, isDynamic: true);

        public void AddSubscription<T, TH>() where T : IntegrationEvent where TH : IIntegrationEventHandler<T>
        {
            var eventName = GetEventKey<T>();

            Subscribe(typeof(TH), eventName, isDynamic: false);
        ...
        private void Subscribe(Type handlerType, string eventName, bool isDynamic)
        {
