...
namespace Utilities.ServiceBus
{
    public class ServiceBus : IEventBus
    {
        ...
        public ServiceBus(IServiceBusPersisterConnection serviceBusPersisterConnection,
            ILogger<ServiceBus> logger, IEventBusSubscriptionsManager subsManager, string subscriptionClientName, ILifetimeScope autofac)
        {
